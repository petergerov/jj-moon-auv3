...
#include <vector>
#include <algorithm>
#include "JJMoonDSPKernel.hpp"
#include "JJMoonBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(JJMoonDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
